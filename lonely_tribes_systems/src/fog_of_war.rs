...
use amethyst::core::ecs::{System, ReadStorage, Read, WriteStorage, Join, Write};
use lonely_tribes_components::tile_transform::TileTransform;
use amethyst::renderer::resources::Tint;
use lonely_tribes_components::point_light::TintOverride;
...
use lonely_tribes_lib::{WIDTH, HEIGHT};
